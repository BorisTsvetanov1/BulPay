...
To understand the complete picture of the problem and how I've used my Product Management skills to solve it please check the Case-Study.md for the complete story. 

Please note that this project is ongoing as we speak, some artifacts are still in progress or not yet uploaded. Advisable to review in the following order:
...
5. BulPay prototype (latest version: V3)
